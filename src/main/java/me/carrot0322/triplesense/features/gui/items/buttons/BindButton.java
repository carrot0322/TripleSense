...
public class BindButton
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        int color = ColorUtil.toARGB(me.carrot0322.triplesense.features.modules.client.ClickGui.getInstance().red.getValue(), me.carrot0322.triplesense.features.modules.client.ClickGui.getInstance().green.getValue(), me.carrot0322.triplesense.features.modules.client.ClickGui.getInstance().blue.getValue(), 255);
        RenderUtil.rect(context.getMatrices(), this.x, this.y, this.x + (float) this.width + 7.4f, this.y + (float) this.height - 0.5f, this.getState() ? (!this.isHovering(mouseX, mouseY) ? 0x11555555 : -2007673515) : (!this.isHovering(mouseX, mouseY) ? TripleSense.colorManager.getColorWithAlpha(TripleSense.moduleManager.getModuleByClass(me.carrot0322.triplesense.features.modules.client.ClickGui.class).hoverAlpha.getValue()) : TripleSense.colorManager.getColorWithAlpha(TripleSense.moduleManager.getModuleByClass(me.carrot0322.triplesense.features.modules.client.ClickGui.class).alpha.getValue())));
        if (this.isListening) {
