package me.carrot0322.triplesense.features.modules;
...
import me.carrot0322.triplesense.manager.ConfigManager;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = TripleSense.moduleManager.getModuleByDisplayName(name);
        Module originalModule = TripleSense.moduleManager.getModuleByName(name);
        if (module == null && originalModule == null) {
            ChatUtil.sendInfo(this.getDisplayName() + ", name: " + this.getName() + ", has been renamed to: " + name);
