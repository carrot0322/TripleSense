package me.carrot0322.triplesense.util.player;

import me.carrot0322.triplesense.TripleSense;
import me.carrot0322.triplesense.event.impl.EventMove;
...
public final class MovementUtility {
    ...
    public static boolean sprintIsLegit(float yaw) {
        return (Math.abs(Math.abs(MathHelper.wrapDegrees(yaw)) - Math.abs(MathHelper.wrapDegrees(TripleSense.playerManager.yaw))) < 40);
    }
}