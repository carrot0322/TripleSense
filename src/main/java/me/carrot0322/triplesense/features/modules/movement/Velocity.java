...
import me.carrot0322.triplesense.event.impl.PacketEvent;
import me.carrot0322.triplesense.features.modules.Module;
import me.carrot0322.triplesense.features.settings.Setting;
import me.carrot0322.triplesense.mixin.IExplosionS2CPacket;
import me.carrot0322.triplesense.mixin.ISPacketEntityVelocity;
import me.carrot0322.triplesense.util.player.MovementUtility;
...
public class Velocity extends Module {
    ...
    public void onPacketReceive(PacketEvent.Receive e) {
        ...
        if (e.getPacket() instanceof EntityVelocityUpdateS2CPacket pac) {
            if (pac.getId() == mc.player.getId() && (!onlyAura.getValue() || TripleSense.moduleManager.isModuleEnabled("Aura"))) {
